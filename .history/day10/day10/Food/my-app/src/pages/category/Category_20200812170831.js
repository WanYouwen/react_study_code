  ...
  render() {
    ...
    return (
      <CategoryContainer>
        ...
        <RouterContainer>
          <Route path = "/category/classify"   exact  children = { () => <CategoryContent pos = {pos} /> }></Route>
          <Route path = "/category/material"  exact  children = { () => <CategoryFoodMaterial pos = {!pos}/>}></Route> 
        </RouterContainer>
      </CategoryContainer>
    )
  }
